...
| [#1145](https://github.com/vercel-labs/agent-browser/pull/1145) | [#1123](https://github.com/vercel-labs/agent-browser/issues/1123) | fix: rewrite getByRole to use CDP accessibility tree with ref-based element resolution | OPEN | 2026-04-05 |
