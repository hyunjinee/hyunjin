...
draft: false
layout: PostBanner
images: ['https://velog.velcdn.com/images/hyunjine/post/a701dad7-a978-4e0b-90b2-0223fa32143e/image.png']
summary: 이 글에서는 Flux 아키텍처가 무엇인지 알아봅니다.
---
...
애플리케이션 아키텍처인 Flux를 이해하기 위해 Flux 아키텍처의 시작점으로 돌아가보려고 합니다.
