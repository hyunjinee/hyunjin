      ...
      <div className="mx-auto max-w-[700px] bg-white dark:bg-gray-900">
        ...
        <div className="mb-6">
          ...
          <div className="space-y-2">
            <p className="text-[14px] leading-[14px] text-black dark:text-gray-200">
        ...
        <div className="grid grid-cols-1 gap-6 mb-6 md:grid-cols-2">
          ...
          <div>
            ...
            <div className="mb-4 space-y-1">
              ...
              <p className="text-[14px] leading-[14px] text-black dark:text-gray-200">AWS EC2, S3, Route 53</p>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-1 text-[14px]">
              <li className="leading-[14px] text-black dark:text-gray-200">
              ...
              <li className=" leading-[14px] text-black dark:text-gray-200">- Webview를 사용하여 지도 및 마커 표시</li>
              <li className=" leading-[14px] text-black dark:text-gray-200">
