        ...
        <div className="mb-16">
          ...
          <div className="relative mb-8">
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <h1 className="text-[30px] font-bold text-[#ea4a9a]">LinkGraph</h1>
            </div>

            {/* Position and Period */}
            <div className="absolute right-0 top-0 text-right">
              <p className="text-[10px] text-black mb-1">개인 프로젝트</p>
              <p className="text-[10px] text-black mb-2">2023.06 ~ 진행중</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            {/* Skills Stack */}
            <div>
              <h2 className="text-[15px] font-bold text-[#ea4a9a] mb-3">기술 스택</h2>
              <div className="space-y-2 mb-4">
                <p className="text-[10px] text-black leading-[14px]">TypeScript, Next, Next Auth</p>
                <p className="text-[10px] text-black leading-[14px]">D3, React Query, TailwindCSS</p>
                <p className="text-[10px] text-black leading-[14px]">S3, CloudFront, PlanetScale, Prisma</p>
              </div>
            ...
            {/* Project Details */}
            <div>
              <h2 className="text-[15px] font-bold text-[#ea4a9a] mb-3">프로젝트 상세</h2>
        ...
        <div className="border-t pt-12">
          ...
          <div className="relative mb-8">
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <h1 className="text-[30px] font-bold text-[#61dafb]">투두투두</h1>
            </div>

            {/* Position and Period */}
            <div className="absolute right-0 top-0 text-right">
              <p className="text-[10px] text-black mb-2">2022.03 ~ 2022.05</p>
              <a
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            {/* Skills Stack */}
            <div>
              <h2 className="text-[15px] font-bold text-[#61dafb] mb-3">기술 스택</h2>
              <div className="space-y-2">
                <p className="text-[10px] text-black leading-[14px]">
                  React, TypeScript, Redux, RTK, Recoil, Zustand, Context API
                </p>
                <p className="text-[10px] text-black leading-[14px]">lighthouse, Cypress, Sass</p>
              </div>
            </div>

            {/* Project Details */}
            <div>
              <h2 className="text-[15px] font-bold text-[#61dafb] mb-3">프로젝트 상세</h2>
              <ul className="space-y-2">
                <li className="text-[10px] text-black leading-[14px] ms-4 list-disc">
                  <a
